...
# Logger Script
# Change the ubuntu@ec2-18-140-236-240.ap-southeast-1.compute.amazonaws.com with datadog instance
sudo echo "#!/bin/bash
while : 
do	
